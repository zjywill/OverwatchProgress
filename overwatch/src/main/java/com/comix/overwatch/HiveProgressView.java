...
public class HiveProgressView extends View {
  ...
  private void initAttributes(AttributeSet attrs, int defStyle) {
    ...
    imageResId = a.getResourceId(R.styleable.HiveProgressView_hive_image, 0);
    a.recycle();
  }
  ...
  private void initImage() {
    if (imageResId != 0) {
      imageRes = getResources().getDrawable(imageResId);
    }
  }
  ...
  private void drawImage(Canvas canvas) {
    ...
    imageRes.setBounds(hexWidth / 2, hexPadding, hexWidth * 3 / 2, hexHeight - hexPadding);
    imageRes.setAlpha(alpha);
    canvas.rotate(10, hexWidth / 2 + hexWidth * 3 / 4 - hexWidth / 4, hexHeight / 2);
    imageRes.draw(canvas);
    canvas.restore();

    canvas.save();
    alpha = getAlpha(2, actualProgress);
    imageRes.setBounds(hexWidth * 3 / 2, hexPadding, hexWidth * 5 / 2, hexHeight - hexPadding);
    imageRes.setAlpha(alpha);
    canvas.rotate(-10, hexWidth * 3 / 2 + hexWidth * 5 / 4 - hexWidth * 3 / 4, hexHeight / 2);
    imageRes.draw(canvas);
    canvas.restore();
    ...
    imageRes.setBounds(0, hexHeight * 3 / 4 + hexPadding, hexWidth, hexHeight * 7 / 4 - hexPadding);
    imageRes.setAlpha(alpha);
    canvas.rotate(-10, hexWidth / 2, hexHeight * 3 / 4 + hexHeight * 7 / 8 - hexHeight * 3 / 8);
    imageRes.draw(canvas);
    canvas.restore();

    canvas.save();
    alpha = getAlpha(7, actualProgress);
    imageRes.setBounds(hexWidth, hexHeight * 3 / 4 + hexPadding, hexWidth * 2,
                       hexHeight * 7 / 4 - hexPadding);
    imageRes.setAlpha(alpha);
    canvas.rotate(5, hexWidth + hexWidth - hexWidth / 2,
                  hexHeight * 3 / 4 + hexHeight * 7 / 8 - hexHeight * 3 / 8);
    imageRes.draw(canvas);
    canvas.restore();

    canvas.save();
    alpha = getAlpha(3, actualProgress);
    imageRes.setBounds(hexWidth * 2, hexHeight * 3 / 4 + hexPadding, hexWidth * 3,
                       hexHeight * 7 / 4 - hexPadding);
    imageRes.setAlpha(alpha);
    canvas.rotate(-10, hexWidth * 2 + hexWidth * 3 / 2 - hexWidth,
                  hexHeight * 3 / 4 + hexHeight * 7 / 8 - hexHeight * 3 / 8);
    imageRes.draw(canvas);
    canvas.restore();
    ...
    imageRes.setBounds(hexWidth / 2, hexHeight * 6 / 4 + hexPadding, hexWidth * 3 / 2,
                       hexHeight * 10 / 4 - hexPadding);
    imageRes.setAlpha(alpha);
    canvas.rotate(20, hexWidth / 2 + hexWidth * 3 / 4 - hexWidth / 4,
                  hexHeight * 6 / 4 + hexHeight * 10 / 8 - hexHeight * 6 / 8);
    imageRes.draw(canvas);
    canvas.restore();

    canvas.save();
    alpha = getAlpha(4, actualProgress);
    imageRes.setBounds(hexWidth * 3 / 2, hexHeight * 6 / 4 + hexPadding, hexWidth * 5 / 2,
                       hexHeight * 10 / 4 - hexPadding);
    imageRes.setAlpha(alpha);
    canvas.rotate(10, hexWidth * 3 / 2 + hexWidth * 5 / 4 - hexWidth * 3 / 4,
                  hexHeight * 6 / 4 + hexHeight * 10 / 4 - hexHeight * 6 / 4);
    imageRes.draw(canvas);
    canvas.restore();
  }
